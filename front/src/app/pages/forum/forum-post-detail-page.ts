...
@Component({
  ...
  template: `
    <div style="max-width:800px">
      <a routerLink="/forum" style="color:#64748b;text-decoration:none;font-size:14px;display:inline-block;margin-bottom:16px">
...
export class ForumPostDetailPage implements OnInit {
  post: any = null;
  comments: any[] = [];
  loading = true;
  newComment = '';
