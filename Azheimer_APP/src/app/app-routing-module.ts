...
const routes: Routes = [
  ...
  { path: 'crud/localization/movement', component: MovementMonitoringComponent, canActivate: [AuthGuard], data: { roles: ['ADMIN', 'DOCTOR', 'PATIENT', 'CAREGIVER'] } },
  { path: 'crud/localization', component: LocalizationEntryComponent, canActivate: [AuthGuard], data: { roles: ['ADMIN', 'DOCTOR', 'PATIENT', 'CAREGIVER'] } },
  ...
  { path: 'crud/activity/manage', component: QuizManagementComponent, canActivate: [AuthGuard], data: { roles: ['ADMIN'] } },
  { path: 'crud/activity/play', component: QuizListComponent, canActivate: [AuthGuard], data: { roles: ['ADMIN', 'PATIENT'] } },
  { path: 'crud/activity/results', component: ResultsComponent, canActivate: [AuthGuard], data: { roles: ['ADMIN', 'DOCTOR', 'CAREGIVER'] } },
  { path: 'crud/activity', component: ActivityEntryComponent, canActivate: [AuthGuard], data: { roles: ['ADMIN', 'DOCTOR', 'PATIENT', 'CAREGIVER'] } },
  { path: 'crud/quiz', component: QuizManagementComponent, canActivate: [AuthGuard], data: { roles: ['ADMIN'] } },
  ...
  { path: 'officiel/register', component: OfficielRegisterComponent },
  {
    ...
    children: [
      ...
      { path: 'results', component: ResultsComponent, canActivate: [AuthGuard], data: { roles: ['ADMIN', 'DOCTOR', 'CAREGIVER'] } },
      ...
      { path: 'movement', component: MovementMonitoringComponent, canActivate: [AuthGuard], data: { roles: ['ADMIN', 'DOCTOR', 'PATIENT', 'CAREGIVER'] } },
      { path: 'quiz-list', component: OffQuizList, canActivate: [AuthGuard], data: { roles: ['ADMIN', 'PATIENT'] } },
      { path: 'play/:type/:id', component: OffQuizPlayer, canActivate: [AuthGuard], data: { roles: ['ADMIN', 'PATIENT'] } },
